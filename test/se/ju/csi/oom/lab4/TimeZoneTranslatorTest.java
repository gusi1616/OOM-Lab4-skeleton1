...
public class TimeZoneTranslatorTest {
	...
	public void testShiftTimeZone() {
		DateTime someDate = new DateTime(1993, 03, 24, 16, 00 ,00);
		
		someDate = TimeZoneTranslator.shiftTimeZone(someDate, 1, -6);
		
		assertEquals(new String("1993-03-24 09:00:00"), someDate.toString());
		
		System.out.println();
		System.out.println(someDate.toString());
		System.out.println("Correct date: 1993-03-24 09:00:00"); 
//		:)fail("Not yet implemented");
	}

	@Test
	public void testShiftEventTimeZone() {
		DateTime startDate = new DateTime(2016, 1, 1, 6, 0, 0);
		DateTime endDate = new DateTime(2016, 1, 1, 8, 0, 0);
		...
		assertEquals(new String("2015-12-31 21:00:00"), event.getStartDate().toString());
		assertEquals(new String("2015-12-31 23:00:00"), event.getEndDate().toString());
